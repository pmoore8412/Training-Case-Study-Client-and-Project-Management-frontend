    ...
    return(
        <>
            <form onSubmit={handleSubmit}>
                <h6>Client Name:</h6>
                <input type="text" name="clientName" id="clientName" className="form-control" style={{width: "300px"}} onChange={handleInputChange} value={inputs.clientName} />
                ...
                <textarea name="clientDescription" id="clientDescription" className="form-control" rows="5" cols="50" 
                ...
                <input type="file" name="agreementFile" id="agreementFile" className="form-control" onChange={handleInputChange} value={inputs.agreementFile} />
